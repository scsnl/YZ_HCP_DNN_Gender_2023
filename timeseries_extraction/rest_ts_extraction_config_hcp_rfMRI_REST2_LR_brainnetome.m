...
% - Subject list
paralist.subjectlist = 'PROJECT_DIR/scripts/restfmri/extract_timeseries/subjectlist_missing_brainnetome_rfMRI_REST2_LR.txt';
...
paralist.roi_dir = 'SCRIPTS_DIR/atlases/brainnetome/3D/'; %'ROI_DIR/';
% output directory
paralist.output_dir = 'PROJECT_DIR/data/imaging/timeseries/participant_level/mat/brainnetome/';
