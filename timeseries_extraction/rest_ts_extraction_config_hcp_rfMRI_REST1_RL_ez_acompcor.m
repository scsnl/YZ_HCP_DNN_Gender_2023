...
paralist.roi_dir = 'SCRATCH_DIR/atlases/ez/3D/'; %'ROI_DIR/';
% output directory
paralist.output_dir = 'PROJECT_DIR/data/imaging/timeseries/participant_level/acompcor/mat/ez/';

% Please specify the ROI list (full file name with extensions; ROI must be in .mat format)
%paralist.roi_list = 'SCRIPTS_DIR/atlases/ez/3D/ez_roi_list.txt';
paralist.roi_list = 'SCRATCH_DIR/atlases/ez/3D/ez_roi_list.txt';
