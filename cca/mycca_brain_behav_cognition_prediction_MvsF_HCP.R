...
# load male CCA model
midfix = "HCP_RL_S1_CCA_msubjs_cognition" 
fname = paste("results/brain_behav/hcp_cca_246roi_3pcs_202209/", midfix, "_perm5000_PCversion.RData",sep="")
load(fname)
plt.name1 = paste("results/brain_behav/hcp_cca_246roi_3pcs_202209/", midfix, "_predictFemale_CxCy_scatter_perm5000.eps", sep="")
...
fname = paste("results/brain_behav/hcp_cca_246roi_3pcs_202209/", midfix, "_perm5000_PCversion.RData",sep="")
load(fname)
plt.name2 = paste("results/brain_behav/hcp_cca_246roi_3pcs_202209/", midfix, "_predictMale_CxCy_scatter_perm5000.eps", sep="")
...
# Cy <- (y_mtx %*% xy.cca.male$ycoef.raw) 
# Cx <- (x_mtx %*% xy.cca.male$xcoef.raw)

Cy <- (y_mtx %*% xy.cca.male$ycoef.std) 
