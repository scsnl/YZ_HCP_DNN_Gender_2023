...
from utilityFunctions_yz import *
import collections
...
if __name__ == '__main__':
    ...
    test_sessions_alias_list = ['LR_S1', 'LR_S2', 'RL_S1', 'RL_S2']
    # test_sessions_list = ['REST2_LR', 'REST2_RL']
    # test_sessions_alias_list = ['LR_S2', 'RL_S2']
    num_5folds = 100

    # # ig
    # output_path = 'PROJECT_DIR/results/restfmri/dnn/feature_excel_files/'
    # deeplift
    output_path = 'PROJECT_DIR/results/restfmri/dnn/DL_feature_excel_files/'
    ...
    # deeplift
    output_nii_path = 'PROJECT_DIR/results/restfmri/dnn/niis_DL/consensus_multiple_cv/'
    ...
    for ii in range(1,4):
        ...
        for percentile in [80]: #[80, 85, 90, 95]: # for each percentile
            for group in groups.keys(): # for each gender
                ...
                # deeplift
                data_path = 'PROJECT_DIR/results/restfmri/dnn/attributions_deeplift/multiple_cv/'
                site = 'hcp_model_' + model_session + '_test_' + test_session

                for jj in range(num_5folds):
                    print("the {} 5folds".format(jj))

                    for m in range(5):
                        data_file = data_path + 'ff' + str(jj) + '_hcp_model_' + model_session + '_index_' + str(m) + '_test_' + test_session + '.npz'
